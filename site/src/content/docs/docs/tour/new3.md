...
Here is an app which lets you track how many minutes you spend on different activities in a day:
...
You'd notice that in the early stages most of your time is in the moving category, and the stalling is mostly future proofing, so it's productive. But as the project grows more complex, you the ratio shifts and your velocity plummets.

There are obviously many factors involved, but one very overlooked factor is the framework itself, which backfires by:
